...
const CatalogMenu = () => {
	...
	const [fourthVisible, setFourthVisible] = React.useState(false)
										...
										>
											{!isMedia450 && (
												<>
													{id === 1 && (
														<CatalogMenuButton
															{...buttonProps(firstVisible)}
														/>
													)}
													{id === 2 && (
														<CatalogMenuButton
															{...buttonProps(secondVisible)}
														/>
													)}
													{id === 3 && (
														<CatalogMenuButton
															{...buttonProps(thirdVisible)}
														/>
													)}
													{id === 4 && (
														<CatalogMenuButton
															{...buttonProps(fourthVisible)}
														/>
													)}
												</>
											)}
											{!isMedia450 && (
												<AnimatePresence>
													{isCurrentList(firstVisible, 1) && (
														<CatalogMenuList items={items} />
													)}
													{isCurrentList(secondVisible, 2) && (
														<CatalogMenuList items={items} />
													)}
													{isCurrentList(thirdVisible, 3) && (
														<CatalogMenuList items={items} />
													)}
													{isCurrentList(fourthVisible, 4) && (
														<CatalogMenuList items={items} />
													)}
												</AnimatePresence>
											)}
